...
- June 26, 2025. Updated WhatsApp message format to use "Halo Otomatix" greeting with "*Data Konsultasi*" bold header and proper structured format including all form fields
```
